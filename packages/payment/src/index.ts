...
export class PaymentApi extends ServiceApi {
    readonly gateways = new RestResource<Gateway, CreateGatewayInput, UpdateGatewayInput, GatewayListResponse, GatewayResponse>(this.client, "/api/v1/gateways");
    readonly transactions = new RestResource<Transaction, never, never, TransactionListResponse, TransactionResponse>(this.client, "/api/v1/transactions");
