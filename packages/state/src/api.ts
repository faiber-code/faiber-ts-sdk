...
export class StateApi extends ServiceApi {
  ...
  /** Enqueues the authenticated user; identity is never accepted in the body. */
  enqueueMatchmaking(gameId: string, data: import("./match.js").EnqueueMatchmakingInput, options?: RequestOptions<import("./match.js").EnqueueMatchmakingInput>) { return this.client.post<{data: import("./match.js").MatchmakingTicket}, import("./match.js").EnqueueMatchmakingInput>(`/api/v2/games/${encodeURIComponent(gameId)}/matchmaking/tickets`, data, options); }
  matchmakingTicket(gameId: string, ticketId: string, options?: RequestOptions) { return this.client.get<{data: import("./match.js").MatchmakingTicket}>(`/api/v2/games/${encodeURIComponent(gameId)}/matchmaking/tickets/${encodeURIComponent(ticketId)}`, undefined, options); }
  cancelMatchmaking(gameId: string, ticketId: string, options?: RequestOptions) { return this.client.delete<{data: import("./match.js").MatchmakingTicket}>(`/api/v2/games/${encodeURIComponent(gameId)}/matchmaking/tickets/${encodeURIComponent(ticketId)}`, options); }
  matchView<View = import("./match.js").MatchView>(matchId: string, options?: RequestOptions) { return this.client.get<{data: View}>(`/api/v2/matches/${encodeURIComponent(matchId)}/view`, undefined, options); }
  createMatchConnection(matchId: string, options?: RequestOptions) { return this.client.post<{data: import("./match.js").MatchConnectionTicket}, Record<string, never>>(`/api/v2/matches/${encodeURIComponent(matchId)}/connections`, {}, options); }
}
