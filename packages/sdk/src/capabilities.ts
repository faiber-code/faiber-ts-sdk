...
export const FAIBER_SERVICE_CAPABILITIES = [
  { service: "idp", title: "Identity", description: "Authentication, sessions, users, roles, permissions, OAuth, OIDC, and access control.", aiGuidance: "Authenticate and manage identity here; never store credentials in generated project code.", transports: ["rest"], operationCount: 96, environmentVariable: "FAIBER_IDP_URL", auth: "Public bootstrap plus Bearer/cookie and permission-guarded administration." },
  ...
  { service: "lms", title: "Learning", description: "Courses, classroom-session scheduling and types, room provisioning state, enrollment, assessments, certificates, homework, and reports.", aiGuidance: "Distinguish learner academy routes from management routes, preserve UUID identifiers, and honor classroom-session lock state before opening provisioned Session rooms.", transports: ["rest"], operationCount: 127, environmentVariable: "FAIBER_LMS_URL", auth: "IDP session with learner context or LMS management permissions." },
