...
export const FAIBER_SERVICE_CAPABILITIES = [
  ...
  { service: "profile", title: "Profiles", description: "Profiles, typed properties, locations, avatars, surveys, metadata, and profile media.", aiGuidance: "Use self-address routes for checkout and atomic profile patch inputs elsewhere; preserve omitted versus null field semantics.", transports: ["rest", "multipart"], operationCount: 172, environmentVariable: "FAIBER_PROFILE_URL", auth: "IDP Bearer token or secure session cookie." },
