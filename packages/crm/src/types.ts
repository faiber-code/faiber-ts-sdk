...
export type CrmWorkflow = O.ApiShowWorkflowRouteGetResponseData;
...
export type CreateCrmWorkflowInput = O.ApiCreateWorkflowRoutePostApiV1WorkflowsInput;
export type UpdateCrmWorkflowInput = O.ApiUpdateWorkflowRoutePatchInput;
export type CreateCrmWorkflowNodeInput = O.ApiCreateWorkflowNodeRoutePostInput;
export type UpdateCrmWorkflowNodeInput = O.ApiUpdateWorkflowNodeRoutePatchInput;
